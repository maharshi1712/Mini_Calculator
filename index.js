...
$('.btn-theme').click(function() {
    if (color === 1) {
        $('#container').css("background", "linear-gradient(to top, #8e9eab, #eef2f3)");
        ...
        $('.top-section,.side-section').css("background", "lightgrey");
        $('.operator').css("background-color", "lightgrey");
        $('.equal').css("background-color", "#FF6A00");
        $('.number').css("background-color", "lightgrey");
